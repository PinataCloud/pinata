...
describe("removeFromGroup function", () => {
  ...
  it("should throw NetworkError on non-401 error response", async () => {
    ...
    await expect(removeFromGroup(mockConfig, mockOptions)).rejects.toThrow(NetworkError);
  });
  ...
  it("should throw PinataError on unexpected errors", async () => {
    ...
    await expect(removeFromGroup(mockConfig, mockOptions)).rejects.toThrow(PinataError);
  });
