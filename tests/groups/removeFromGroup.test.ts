import { removeFromGroup } from "../../src/core/functions/groups/removeFromGroup";
...
describe("removeFromGroup function", () => {
  describe("public network", () => {
    ...
    it("should remove files from group successfully", async () => {
      const mockOptions = {
        groupId: "test-group",
      ...
      const result = await removeFromGroup(mockConfig, mockOptions, "public");
    ...
    it("should throw ValidationError if config is missing", async () => {
      ...
      await expect(removeFromGroup(undefined, mockOptions, "public")).rejects.toThrow(ValidationError);
    });
  ...
  describe("private network", () => {
    ...
    it("should remove files from group successfully", async () => {
      ...
      const result = await removeFromGroup(mockConfig, mockOptions, "private");
    ...
    it("should throw ValidationError if config is missing", async () => {
      ...
      await expect(removeFromGroup(undefined, mockOptions, "private")).rejects.toThrow(ValidationError);
    });
