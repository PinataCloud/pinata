...
describe("createGroup function", () => {
    ...
    it("should handle group creation with a very long name", async () => {
        ...
        global.fetch = jest.fn().mockResolvedValueOnce({
            ...
            json: jest
                .fn()
                .mockResolvedValueOnce({ data: { id: "group-123", name: longNameOptions.name, is_public: false, createdAt: "2023-07-26T12:00:00Z" } }),
        });
    ...
    it("should handle group creation with special characters in name", async () => {
        ...
        global.fetch = jest.fn().mockResolvedValueOnce({
            ...
            json: jest.fn().mockResolvedValueOnce({
                data: { id: "group-123", name: specialNameOptions.name, is_public: false, createdAt: "2023-07-26T12:00:00Z" },
            }),
        });
    ...
    it("should handle empty group name", async () => {
        ...
        global.fetch = jest.fn().mockResolvedValueOnce({
            ok: true,
            json: jest.fn().mockResolvedValueOnce({ data: { id: "group-123", name: "", is_public: false, createdAt: "2023-07-26T12:00:00Z" } }),
        });
