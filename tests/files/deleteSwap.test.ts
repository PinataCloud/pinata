...
describe("deleteSwap function", () => {
	describe("public network", () => {
		...
		it("should throw ValidationError if config is missing", async () => {
			await expect(deleteSwap(undefined, "test-cid", "public")).rejects.toThrow(
				ValidationError,
			);
		});
		...
		it("should throw AuthenticationError on 401 response", async () => {
			...
			await expect(
				deleteSwap(mockConfig, "test-cid", "public"),
	...
	describe("private network", () => {
		...
		it("should throw ValidationError if config is missing", async () => {
			await expect(
				deleteSwap(undefined, "test-cid", "private"),
		...
		it("should throw AuthenticationError on 401 response", async () => {
			...
			await expect(
				deleteSwap(mockConfig, "test-cid", "private"),
			).rejects.toThrow(AuthenticationError);
		});
