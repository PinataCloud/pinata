...
describe("updateFile function", () => {
  ...
  describe("public network", () => {
    ...
    it("should throw ValidationError if config is missing", async () => {
      await expect(updateFile(undefined, mockOptions, "public")).rejects.toThrow(
        ValidationError,
      );
    });
    ...
    it("should throw AuthenticationError on 401 response", async () => {
      ...
      await expect(updateFile(mockConfig, mockOptions, "public")).rejects.toThrow(
        AuthenticationError,
      );
    });
  ...
  describe("private network", () => {
    ...
    it("should throw ValidationError if config is missing", async () => {
      await expect(updateFile(undefined, mockOptions, "private")).rejects.toThrow(
        ValidationError,
      );
    });
    ...
    it("should throw AuthenticationError on 401 response", async () => {
      ...
      await expect(updateFile(mockConfig, mockOptions, "private")).rejects.toThrow(
        AuthenticationError,
      );
    });
