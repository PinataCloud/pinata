...
describe("swapHistory function", () => {
  describe("public network", () => {
    ...
    it("should throw ValidationError if config is missing", async () => {
      ...
      await expect(swapHistory(undefined, mockOptions, "public")).rejects.toThrow(ValidationError);
    });
    ...
    it("should throw AuthenticationError on 401 response", async () => {
      ...
      await expect(swapHistory(mockConfig, mockOptions, "public")).rejects.toThrow(AuthenticationError);
    });
    ...
    it("should throw NetworkError on 404 response", async () => {
      ...
      await expect(swapHistory(mockConfig, mockOptions, "public")).rejects.toThrow(PinataError);
    });
    ...
    it("should throw NetworkError on non-401/404 error response", async () => {
      ...
      await expect(swapHistory(mockConfig, mockOptions, "public")).rejects.toThrow(NetworkError);
    });
  ...
  describe("private network", () => {
    ...
    it("should throw ValidationError if config is missing", async () => {
      ...
      await expect(swapHistory(undefined, mockOptions, "private")).rejects.toThrow(ValidationError);
    });
    ...
    it("should throw AuthenticationError on 401 response", async () => {
      ...
      await expect(swapHistory(mockConfig, mockOptions, "private")).rejects.toThrow(AuthenticationError);
    });
    ...
    it("should throw NetworkError on 404 response", async () => {
      ...
      await expect(swapHistory(mockConfig, mockOptions, "private")).rejects.toThrow(PinataError);
    });
    ...
    it("should throw NetworkError on non-401/404 error response", async () => {
      ...
      await expect(swapHistory(mockConfig, mockOptions, "private")).rejects.toThrow(NetworkError);
    });
